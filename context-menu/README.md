...
- **`new-json-document`**: Adds a JSON template to the "New" menu.
- **`open-in-terminal`**: Adds or tweaks terminal shell options.

See [TAXONOMY.md](../docs/TAXONOMY.md) for contribution rules and template guidelines.
